    ...
    <div class="row">
      <div class="card mb-4">
        <div class="row">
          <div class="col-md-6">
            <div class="card-body">
              <form action="<?= base_url('barang/aksi_tambah_barang/')?>" method="post">

                <div class="mb-3">
                  <label for="email" class="form-label">Nama Obat</label>
                  <input type="text" class="form-control" id="nama" placeholder="Masukkan Nama Obatt" name="nama_brg"  required>

                <div class="mb-3">
                  <label for="email" class="form-label">Kode Obat</label>
                  <input type="text" class="form-control" id="kode" placeholder="Masukkan Kode Obat" name="kode_brg" required>
                </div>

                <div class="mb-3">
                  <label for="email" class="form-label">Stock</label>
                  <input type="text" class="form-control" id="stock" placeholder="Masukkan Stock" name="stock" required>
                </div>
