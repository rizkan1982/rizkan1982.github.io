  ...
  <div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="row">
      <div class="col-md-6">
        <div class="card mb-4">
          <div class="card-body">
            <form action="<?= base_url('level/aksi_create/')?>" method="post">

              <div class="mb-3">
                <label for="email" class="form-label">Nama Level</label>
                <input type="text" class="form-control" id="nama_level" placeholder="Masukkan Nama Level" name="nama_level" required>
              </div>
