  ...
  <div class="layout-wrapper layout-content-navbar">
    <div class="layout-container">
      ...
      <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
        ...
        <span class="app-brand-text demo menu-text fw-bolder ms-2">Apotek</span>
      </a>
    ...
    <ul class="menu-inner py-1">
      ...
      <li class="menu-item">
        <a href="<?=base_url('barang_keluar')?>" class="menu-link">
          <i class="menu-icon tf-icons bx bx-pen"></i>
          <div>Obat Keluar</div>
        </a>
      </li>
      <li class="menu-item">
        <a href="<?=base_url('Home/l_brg')?>" class="menu-link">
          <i class="menu-icon tf-icons bx bx-book"></i>
          <div>Laporan Obat</div>
        </a>
      </li>
      <li class="menu-item">
        <a href="<?=base_url('Home/l_masuk')?>" class="menu-link">
          <i class="menu-icon tf-icons bx bx-book"></i>
          <div>Laporan Obat Masuk</div>
        </a>
      </li>
      <li class="menu-item">
        <a href="<?=base_url('Home/l_penjualan')?>" class="menu-link">
          <i class="menu-icon tf-icons bx bx-book"></i>
          <div>Laporan Obat Keluar</div>
        </a>
      </li>
      <li class="menu-header small text-uppercase">
